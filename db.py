...
def create_table():
    c.execute('CREATE TABLE IF NOT EXISTS userstable(id INTEGER PRIMARY KEY,email TEXT UNIQUE,password TEXT)')
    c.execute('CREATE TABLE IF NOT EXISTS Accueil(id INTEGER PRIMARY KEY,IDD TEXT,Chantier TEXT,NArrivant VARCHAR,Ninduction VARCHAR,Date DATE)')
    c.execute('CREATE TABLE IF NOT EXISTS TBM(id INTEGER PRIMARY KEY,IDD TEXT,Chantier TEXT,NChantier VARCHAR,NTBM VARCHAR,Date DATE)')
    c.execute('CREATE TABLE IF NOT EXISTS NC(id INTEGER PRIMARY KEY,IDD TEXT,Chantier TEXT,NCR VARCHAR,FNCR VARCHAR,NCC VARCHAR,FNCC VARCHAR,Date DATE)')
    c.execute('CREATE TABLE IF NOT EXISTS Changements(id INTEGER PRIMARY KEY,IDD TEXT,Chantier TEXT,NCH VARCHAR,FNCH VARCHAR,NCHC VARCHAR,FNCHC VARCHAR,Date DATE)')
    c.execute('CREATE TABLE IF NOT EXISTS Anomalies(id INTEGER PRIMARY KEY,IDD TEXT,Chantier TEXT,NA VARCHAR,FNA VARCHAR,NAC VARCHAR,FNAC VARCHAR,Date DATE)')
    c.execute('CREATE TABLE IF NOT EXISTS JSA(id INTEGER PRIMARY KEY,IDD TEXT,Chantier TEXT,NAct VARCHAR,NJSA VARCHAR,Date DATE)')
    c.execute('CREATE TABLE IF NOT EXISTS Incident_Accident(id INTEGER PRIMARY KEY,IDD TEXT,Chantier TEXT,NInc VARCHAR,AAA VARCHAR,ASA VARCHAR,AT VARCHAR,NJP VARCHAR,Date DATE)')
    c.execute('CREATE TABLE IF NOT EXISTS Audit(id INTEGER PRIMARY KEY,IDD TEXT,Chantier TEXT,AC VARCHAR,VC VARCHAR,NEU VARCHAR,SMPAR VARCHAR,NPR VARCHAR,IE VARCHAR,Date DATE)')
