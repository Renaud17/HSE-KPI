                ...
                if task == "":
                    ...
                    #visualisation des données
                        ...
                        with ACCUEIL_exp:
                            ...
                            unique_vals1 = list(dict.fromkeys([y for x in splitted_df_Accueil1[1:] for y in x]).keys())
                        ...
                        with CHANGEMENTS_exp:
                            ...
                            unique_vals4 = list(dict.fromkeys([y for x in splitted_df_Changements1[1:] for y in x]).keys())
                        ...
                        with ANOMALIES_exp:
                            ...
                            unique_vals5 = list(dict.fromkeys([y for x in splitted_df_Anomalies1[1:] for y in x]).keys())
                        ...
                        with AUDIT_exp:
                            ...
                            unique_vals8 = list(dict.fromkeys([y for x in splitted_df_Audit1[1:] for y in x]).keys())
