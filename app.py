...
def main():
    ...
    if choice == "Accueil":
                ...
                if task == "":
                    ...
                    #visualisation des données
                        ...
                        with ACCUEIL_exp:
                            ...
                            unique_vals1 = list(dict.fromkeys([y for x in splitted_df_Accueil1[2:] for y in x]).keys())
                        ...
                        with BRIEFING_exp:
                            ...
                            unique_vals2 = list(dict.fromkeys([y for x in splitted_df_TBM1[2:] for y in x]).keys())
                        ...
                        with CONFORMITÉ_exp:
                            ...
                            unique_vals3 = list(dict.fromkeys([y for x in splitted_df_NC1[2:] for y in x]).keys())
                        ...
                        with CHANGEMENTS_exp:
                            ...
                            unique_vals4 = list(dict.fromkeys([y for x in splitted_df_Changements1[2:] for y in x]).keys())
                        ...
                        with ANOMALIES_exp:
                            ...
                            unique_vals5 = list(dict.fromkeys([y for x in splitted_df_Anomalies1[2:] for y in x]).keys())
                        ...
                        with ANALYSE_exp:
                            ...
                            unique_vals6 = list(dict.fromkeys([y for x in splitted_df_JSA1[2:] for y in x]).keys())
                        ...
                        with INCIDENT_exp:
                            ...
                            unique_vals7 = list(dict.fromkeys([y for x in splitted_df_IA1[2:] for y in x]).keys())
                        ...
                        with AUDIT_exp:
                            ...
                            unique_vals8 = list(dict.fromkeys([y for x in splitted_df_Audit1[2:] for y in x]).keys())
                    ...
                    #Modification
                        ...
                        with st.beta_expander("ANALYSE DES RISQUES RÉALISÉS(JSA)"):
                            ...
                            splitted_df_JSA1 = df_JSA1['Chantier'].str.split(',')
                            unique_vals6 = list(dict.fromkeys([y for x in splitted_df_JSA1[2:] for y in x]).keys())
                            filtrechantier6 = st.selectbox('AFFICHEZ VOTRE GRILLE EN FONCTION DU CHANTIER', unique_vals6,key=16)
                            ...
                            if name_result:
                                ...
                                splitted_df_JSA1 = df_JSA1['Chantier'].str.split(',')
                                unique_vals6 = list(dict.fromkeys([y for x in splitted_df_JSA1[2:] for y in x]).keys())
                                filtrechantier6 = st.selectbox('AFFICHEZ VOTRE GRILLE EN FONCTION DU CHANTIER', unique_vals6,key=17)
                                mask = (df_JSA1['Chantier'] == filtrechantier6)
                                df_filter6=df_JSA1.loc[mask]
                                st.dataframe(df_filter6)
                        ...
                        with st.beta_expander("AUDIT CHANTIER; VISITE CONJOINTE;  PRÉVENTION ET INSPECTION"):
                            ...
                            if name_result:
                                ...
                                splitted_df_Audit1 = df_Audit1['Chantier'].str.split(',')
                                unique_vals8 = list(dict.fromkeys([y for x in splitted_df_Audit1[2:] for y in x]).keys())
                                filtrechantier8 = st.selectbox('AFFICHEZ VOTRE GRILLE EN FONCTION DU CHANTIER', unique_vals8,key=21)
                                mask = (df_Audit1['Chantier'] == filtrechantier8)
                                df_filter8=df_Audit1.loc[mask]
                                st.dataframe(df_filter8)
                    ...
                    #Suppression des données
                        ...
                        with st.beta_expander("AUDIT CHANTIER; VISITE CONJOINTE;  PRÉVENTION ET INSPECTION"):
                            ...
                            splitted_df_Audit1 = df_Audit1['Chantier'].str.split(',')
                            unique_vals8 = list(dict.fromkeys([y for x in splitted_df_Audit1[2:] for y in x]).keys())
                            filtrechantier8 = st.selectbox('AFFICHEZ VOTRE GRILLE EN FONCTION DU CHANTIER', unique_vals8,key=35)
                            mask = (df_Audit1['Chantier'] == filtrechantier8)
                            df_filter8=df_Audit1.loc[mask]
                            st.dataframe(df_filter8)
        ...
        st.image("https://www.energierecrute.com/public/img/fiches_metiers/ingenieur-HSE.jpg",width=700,)
